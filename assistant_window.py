...
class AssistantWindow(Gtk.Window):
    ...
    def _show_privacy_dialog(self):
        ...
        # Card 1: Zero Third-Party Advertiser Sharing
        c1 = Gtk.Box(orientation=Gtk.Orientation.VERTICAL, spacing=6)
        c1.get_style_context().add_class("ios-card")
        c1_title = Gtk.Label()
        c1_title.set_markup("<b>🛡️ Zero 3rd-Party Advertiser Sharing</b>")
        c1_title.set_xalign(0)
        c1.pack_start(c1_title, False, False, 0)

        c1_desc = Gtk.Label(
            label="• No Data Sales or Advertising: We do not sell, rent, monetize, or share your personal data, computer activity, or browsing history with ANY third-party advertisers, data brokers, or marketing networks.\n"
        ...
        # Card 5: Legal Disclaimers & Trademarks
        c5 = Gtk.Box(orientation=Gtk.Orientation.VERTICAL, spacing=6)
        c5.get_style_context().add_class("ios-card")
        c5_title = Gtk.Label()
        c5_title.set_markup("<b>⚖️ Legal Disclaimers &amp; Trademark Notice</b>")
        c5_title.set_xalign(0)
        c5.pack_start(c5_title, False, False, 0)

        c5_desc = Gtk.Label(
            label="• AI Guidance: Technical suggestions from Agy are generated by AI for informational purposes. Verify commands before running.\n"
                  "• Scam Help Scope: Scam protection is educational and does not constitute formal legal, forensic, or financial advice.\n"
                  "• Non-Affiliation: Agy Helper is an independent open-source project and is not affiliated with, sponsored by, or endorsed by Google, Mozilla, Brave, VideoLAN, LibreOffice, Spotify, or Zoom. All trademarks belong to their respective owners."
        )
        c5_desc.set_line_wrap(True)
        c5_desc.set_xalign(0)
        c5_desc.get_style_context().add_class("header-subtitle")
        c5.pack_start(c5_desc, False, False, 0)
        vbox.pack_start(c5, False, False, 0)
